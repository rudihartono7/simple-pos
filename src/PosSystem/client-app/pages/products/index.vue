  ...
  <div>
    ...
    <div class="mb-8">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-3xl font-bold text-black">Product Management</h1>
          <p class="mt-2 text-sm text-neutral-gray">Manage your product catalog and inventory</p>
        </div>
      ...
      <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex flex-wrap gap-3">
          <button
            ...
            :class="[
              ...
              showLowStock 
                ...
                : 'bg-neutral-light text-neutral-gray hover:bg-neutral-medium'
            ]"
          >
          ...
          <button
            ...
            class="px-4 py-3 bg-neutral-light text-neutral-gray rounded-xl text-sm font-medium hover:bg-neutral-medium transition-all duration-200"
          >
            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div v-if="loading" class="flex items-center justify-center py-12">
      <div class="text-center">
        ...
        <p class="mt-4 text-neutral-gray">Loading products...</p>
      </div>
    </div>
    ...
    <div v-else-if="filteredProducts.length === 0" class="text-center py-12">
      ...
      <h3 class="mt-4 text-lg font-medium text-black">No products found</h3>
      <p class="mt-2 text-neutral-gray">Get started by adding your first product.</p>
      <div class="mt-6">
        <button
          @click="showCreateModal = true"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <!-- Product Image -->
        <div class="mb-4">
          <div class="w-full h-48 bg-neutral-light rounded-xl overflow-hidden">
            <img
            ...
            />
            <div v-else class="w-full h-full flex items-center justify-center text-neutral-gray">
        ...
        <div class="flex items-start justify-between mb-4">
          <div class="flex-1">
            <h3 class="text-lg font-semibold text-black mb-1">{{ product.productName }}</h3>
            <p class="text-sm text-neutral-gray line-clamp-2">{{ product.description || 'No description' }}</p>
          </div>
          <div class="relative ml-4">
            <button
              @click="toggleProductActions(product.id)"
              class="p-2 text-neutral-gray hover:text-black rounded-lg hover:bg-neutral-light transition-colors duration-200"
            >
            ...
            <div
              ...
              class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-neutral-medium py-2 z-10"
            >
              <button
                @click="updateStock(product)"
                class="w-full text-left px-4 py-2 text-sm text-black hover:bg-neutral-light flex items-center"
              >
              ...
              <button
                ...
                class="w-full text-left px-4 py-2 text-sm text-danger hover:bg-danger-light flex items-center"
              >
                <svg class="w-4 h-4 mr-3 text-danger" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-3 mb-4">
          <div class="flex items-center justify-between text-sm">
            <span class="text-neutral-gray">Code:</span>
            <span class="font-medium text-black">{{ product.productCode }}</span>
          </div>
          <div v-if="product.barcode" class="flex items-center justify-between text-sm">
            <span class="text-neutral-gray">Barcode:</span>
            <span class="font-medium text-black">{{ product.barcode }}</span>
          </div>
          <div class="flex items-center justify-between text-sm">
            <span class="text-neutral-gray">Category:</span>
            <span class="font-medium text-black">{{ product.categoryName || 'N/A' }}</span>
          </div>
          <div class="flex items-center justify-between text-sm">
            <span class="text-neutral-gray">Unit:</span>
            <span class="font-medium text-black">{{ product.unitOfMeasure || 'PCS' }}</span>
          </div>
        </div>
        ...
        <div class="bg-neutral-light rounded-xl p-4 mb-4">
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm text-neutral-gray">Selling Price</span>
            <span class="text-lg font-bold text-black">Rp {{ formatCurrency(product.unitPrice) }}</span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-neutral-gray">Cost Price</span>
            <span class="text-sm font-medium text-neutral-gray">Rp {{ formatCurrency(product.costPrice) }}</span>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="inline-flex items-center px-4 py-2 bg-primary text-black text-sm font-medium rounded-lg hover:bg-primary-dark transition-colors duration-200"
          >
