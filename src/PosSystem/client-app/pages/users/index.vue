  ...
  <div class="p-6">
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-2"
        >
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
      <div class="flex flex-wrap gap-4 items-center">
        ...
        <select
          v-model="roleFilter"
          class="px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white min-w-32"
        >
        ...
        <button
          @click="loadUsers"
          :disabled="loading"
          class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-3 rounded-xl font-medium disabled:opacity-50 transition-all duration-200 flex items-center space-x-2"
        >
    ...
    <!-- Users Grid -->
    <div v-else-if="filteredUsers.length > 0" class="grid gap-4">
      <div
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
              <div class="flex items-center space-x-3 mb-1">
                ...
                <span class="px-3 py-1 text-xs font-medium rounded-full bg-indigo-100 text-indigo-800 border border-indigo-200">
                  {{ userItem.role }}
                </span>
              </div>
          ...
          <div class="flex items-center space-x-2">
            <button
              ...
              class="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 flex items-center space-x-1"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative">
              <button
                ...
                class="bg-gray-50 hover:bg-gray-100 text-gray-700 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200"
              >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <button
                  ...
                  class="w-full text-left px-4 py-2 text-sm text-yellow-700 hover:bg-yellow-50 flex items-center space-x-2"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  class="w-full text-left px-4 py-2 text-sm text-green-700 hover:bg-green-50 flex items-center space-x-2"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  class="w-full text-left px-4 py-2 text-sm text-purple-700 hover:bg-purple-50 flex items-center space-x-2"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div v-else class="text-center py-16">
      ...
      <button
        @click="openCreateModal"
        class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center space-x-2"
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
        </svg>
